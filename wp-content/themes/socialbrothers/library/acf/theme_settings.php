...
function acf_theme_settings()
{
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            [
                'key'       => "{$prefix}_locations_tab",
                'label'     => __('Locaties', '_SBB'),
                'type'      => 'tab',
                'placement' => 'left',
            ],
            [
                'key'       => "{$prefix}_locations",
                'name'      => 'locations',
                'label'     => __('Locaties', '_SBB'),
                'type'      => 'repeater',
                'layout'    => 'block',
                'sub_fields' => [
                    [
                        'key'          => "{$prefix}_location_name",
                        'name'         => 'name',
                        'label'        => __('Locatie naam', '_SBB'),
                        'type'         => 'text',
                        'wrapper'      => ['width' => 100],
                        'instructions' => __('Voeg hier de naam van de locatie toe', '_SBB'),
                    ],
                    [
                        'key'          => "{$prefix}_location_phone",
                        'name'         => 'phone',
                        'label'        => __('Telefoonnummer', '_SBB'),
                        'type'         => 'text',
                        'wrapper'      => ['width' => 50],
                        'instructions' => __('Voeg hier het telefoonnummer van de locatie toe', '_SBB'),
                    ],
                    [
                        'key'          => "{$prefix}_location_email",
                        'name'         => 'email',
                        'label'        => __('Email', '_SBB'),
                        'type'         => 'text',
                        'wrapper'      => ['width' => 50],
                        'instructions' => __('Voeg hier het e-mailadres van de locatie toe', '_SBB'),
                    ],
                    [
                        'key'       => "{$prefix}_location_address",
                        'name'      => 'address',
                        'label'     => __('Adres', '_SBB'),
                        'type'      => 'textarea',
                        'new_lines' => 'br',
